...
import type Response = Success + Str String + Bn Bin + Failure IOError + Tag (List (String # Char)) + BinTag (List (String # Bin)) + StrList (List String) + Fil File + Dbl Double + AsyncInput AsyncInput + SocketResponse SocketResponse + XResponse XResponse + IntResp Int + SelectResp (List (#3 (List File) (List File) (List Double))) + SigActResp SigAct + CCallResp _CUnion;
