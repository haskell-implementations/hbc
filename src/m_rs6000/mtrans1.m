...
||  mc (m.ms) = m.mc ms
||  mc [] = []
and invj (Mjcond cc1 l1.Mjcond cc2 l2.ms) = Mjcond (invmop cc1) l1. Mjcond (invmop cc2) l2. mc ms
||  invj (Mjcond cc l.ms) = Mjcond (invmop cc) l. mc ms
...
-- extra word for call
and mx (Mcalltag t _) (H,S,V) /*& (~TestEval | t ~= oeval)*/ = (H,S,V-1)
...
and mtrans1 = map mk o mt (0,0,0) o mc o mv o msf
end
