import retfixup: (List *a) {# ARITY _ = 0 #}{# STRICTNESS _ = "T,T" ST #};
import farcase: Bool {# ARITY _ = 0 #}{# STRICTNESS _ = "T,T" ST #};
import dfloatsize: Int {# ARITY _ = 0 #}{# STRICTNESS _ = "T,T" ST #};
import sfloatsize: Int {# ARITY _ = 0 #}{# STRICTNESS _ = "T,T" ST #};
import cputype: String {# ARITY _ = 0 #}{# STRICTNESS _ = "T,F" ST #};
