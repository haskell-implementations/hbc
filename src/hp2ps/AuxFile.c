...
static void GetAuxLine();		/* forward */
static void GetAuxTok();		/* forward */

void GetAuxFile(auxfp)
FILE* auxfp;
{
    ch = ' ';
    endfile = 0;
 ...
 *      the corresponding value is also assigned to "thefloat"; 
