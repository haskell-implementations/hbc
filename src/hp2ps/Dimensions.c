...
float borderheight   = BORDER_HEIGHT;
float borderwidth    = BORDER_WIDTH;
float borderspace    = BORDER_SPACE;
float borderthick    = BORDER_THICK;

float titlewidth     = (BORDER_WIDTH  - (2 * BORDER_SPACE)); 
float titletextspace = TITLE_TEXT_SPACE;
float titleheight; 



float graphx0 = GRAPH_X0;
float graphy0 = GRAPH_Y0;
